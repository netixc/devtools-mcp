...
- **GetErrorHelp**: Get help with troubleshooting common errors and issues
- **GetQuickStart**: Get quick start guides for different types of tasks

When you're unsure about how to use a tool or approach a problem, use these guidance tools first. They contain the collective knowledge of how to use the tools effectively and avoid common pitfalls.

Examples:
- Before using a tool you're unfamiliar with: GetToolGuidance with the tool name
- When facing a complex workflow: GetWorkflowGuidance to see common patterns
- When encountering errors: GetErrorHelp with the error message
- When starting a new type of task: GetQuickStart with the task type

These guidance tools are designed to help you work more efficiently and avoid common mistakes.`;